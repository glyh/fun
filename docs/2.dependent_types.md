...
| `lib/syntax/core_lexer.ml` / `lib/syntax/core_parser.mly` | expression and module parser |

Tests live in `test/backend/test_core.ml`, `test/semantic/test_elaborate.ml`, and `test/syntax/test_match_parse.ml`.

...
- [ ] Structured errors with spans for core parse paths
- [ ] Recovery doesn't produce cascading errors on single-line REPL
- [ ] Multi-statement modules report all parse errors, not just first
- [ ] Existing tests pass (error messages may change)
- [ ] Enforest.ml line count doesn't grow significantly

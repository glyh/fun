...
| 6 | `deref` on a value of unknown type | **decided (user): infer a reference** — [deref-of-unknown-type-is-not-a-reference](deref-of-unknown-type-is-not-a-reference.md) |

let expand_syntax ?elaborate ?eval_and_apply ?load_macros ?syntax_nominals ?expansion_position stx =
...
let parse_module_with_ctx ?elaborate ?eval_and_apply ?load_macros ?load_syntax ?syntax_nominals ?expansion_position source =
  ...
  Enforest.parse_module ?load_syntax source |> expand_syntax ?elaborate ?eval_and_apply ?load_macros ?syntax_nominals ~expansion_position
